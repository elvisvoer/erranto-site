...
Indeed, this solution yields better results, as you can see in the results below.
...
With just a few changes to the original code, we have reached our goal of having

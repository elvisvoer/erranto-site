...
actually use any frontend framework I want, and more than one at a time. During
the transition, I also reworked the entire design (based on
[Flowbite](https://flowbite.com/)) and removed the comments section. That's
something I am considering bringing back to make the site a little more
interactive. You might have also noticed that the About page needs some proper love.
